                  ...
                  <div>
                    <h2 className="card-title">ส่วนที่ 3 การประเมินสถานการณ์น้ำ</h2>
                      <p style={{color: 'var(--text-muted)', marginBottom: '1rem', fontSize: '0.95rem'}}>
                        กรุณาประเมินสถานการณ์โดยให้คะแนนตั้งแต่ 1 ถึง 5<br/>
                        <span style={{color: '#10b981', fontWeight: 'bold'}}>ระดับ 5</span> = ดีมาก / เพียงพอมากที่สุด / มีการดำเนินการครบถ้วน<br/>
                        <span style={{color: '#ef4444', fontWeight: 'bold'}}>ระดับ 1</span> = แย่มาก / มีปัญหารุนแรงที่สุด / ไม่มีการดำเนินการเลย
                      </p>
                        ...
                        <div key={item.id} style={{ padding: '0.75rem', background: index % 2 === 0 ? '#f9fafb' : 'white', borderRadius: '4px' }}>
                          ...
                          {item.id === 'e10' && (
                            <div style={{ marginTop: '0.75rem' }}>
                              <input type="text" name="e10_topic" className="form-control" placeholder="โปรดระบุเรื่องที่รณรงค์ (ถ้ามี)..." value={formData.e10_topic || ''} onChange={handleChange} />
                            </div>
                          )}
                        </div>
                      ))}
